...
$(document).ready(function(){$(".darkshadow").click(function(){$("#nav-menu1").removeClass("shows");});});
$(document).ready(function(){$(".darkshadow").click(function(){$(".darkshadow").removeClass("shows");});});
$(document).ready(function(){$(".toggleMenu").click(function(){$(".darkshadow").toggleClass("shows");});});
$(document).ready(function(){$("#info2").click(function(){$("#nav-menu1").toggleClass("shows");});});
$(document).ready(function(){$("#infosaya").click(function(){$("#nav-menu3").toggleClass("shows");});});
